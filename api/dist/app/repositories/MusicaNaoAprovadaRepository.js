...
let MusicaNaoAprovadaRepository = class MusicaNaoAprovadaRepository {
    async getById(id) {
        const query = `
...
], MusicaNaoAprovadaRepository.prototype, "database", void 0);
MusicaNaoAprovadaRepository = __decorate([
    typedi_1.Service()
], MusicaNaoAprovadaRepository);
exports.default = MusicaNaoAprovadaRepository;
